from PySide6.QtWidgets import (QDialog, QVBoxLayout, QHBoxLayout, QLabel, 
                                 QSlider, QPushButton, QMessageBox, QFrame, QCheckBox)
...
class SettingsDialog(QDialog):
    ...
    def __init__(self, current_threshold, 
                 face_det_thresh=35, face_min_samples=2, 
                 face_cluster_eps=42, face_merge_threshold=55,
                 current_dup_threshold=6, 
                 current_dup_threshold_stage2=95,
                 force_reanalyze=False, include_trash=False, parent=None):
    ...
    def init_ui(self):
        ...
        face_layout.addWidget(QLabel("※低いほど多くの顔を検出しますが、誤検知も増えます。標準は0.35です。"))
        ...
        face_layout.addWidget(QLabel("※これ以上の回数出現した顔を、自動的に新しい人物として登録します。標準は2回です。"))
        ...
        face_layout.addWidget(QLabel("※自動的にマージする閾値です。高いほど厳密（似ている必要がある）になります。"))
        ...
        face_layout.addWidget(QLabel("※「確認エリア」に送る閾値です。自動マージよりも広い範囲をカバーします。"))
